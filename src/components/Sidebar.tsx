      ...
      <aside className={`fixed top-0 left-0 bottom-0 bg-[rgba(10,10,26,0.95)] backdrop-blur-[20px] border-r border-border-subtle z-[110] flex flex-col py-lg transition-all duration-250 shadow-lg overflow-visible ${isExpanded ? "w-[240px]" : "w-[72px]"} max-md:w-[280px] max-md:-translate-x-full [.sidebar-open_&]:max-md:translate-x-0`}>
        <div className="flex items-center justify-between px-md mb-xl overflow-hidden">
          <div className="flex items-center gap-sm">
            ...
            <span className={`font-heading text-xl font-extrabold tracking-[-0.5px] gap-xs transition-opacity duration-150 ${isExpanded ? "flex opacity-100 whitespace-nowrap" : "hidden opacity-0"} max-md:flex max-md:opacity-100`}>
        ...
        <div className="flex flex-col gap-sm px-md">
          ...
          >
            ...
            <span className={`transition-opacity duration-150 ${isExpanded ? "flex opacity-100 whitespace-nowrap" : "hidden opacity-0"} max-md:flex max-md:opacity-100`}>{t("home")}</span>
          </Link>
          ...
          >
            ...
            <span className={`transition-opacity duration-150 ${isExpanded ? "flex opacity-100 whitespace-nowrap" : "hidden opacity-0"} max-md:flex max-md:opacity-100`}>{t("myBets")}</span>
          </Link>
        </div>
